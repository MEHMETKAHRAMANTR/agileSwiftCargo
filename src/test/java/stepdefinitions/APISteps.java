...
public class APISteps {
    ...
    public void get_hub_id_icin_donen_response_in_dogrulamasi_yapilir() {
        ...
        assertEquals(expData.get("name"), resJP.get("name"));
        assertEquals(expData.get("phone"), resJP.get("phone"));
        assertEquals(expData.get("address"), resJP.get("address"));
        assertEquals(expData.get("current_balance"), resJP.get("current_balance"));
        assertEquals(expData.get("status"), resJP.get("status"));
        assertEquals(expData.get("created_at"), resJP.get("created_at"));
        assertEquals(expData.get("updated_at"), resJP.get("updated_at"));
